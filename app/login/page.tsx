      ...
      >
        ...
        <div className="mx-auto space-y-6">
          <div className="space-y-2 text-center">
            ...
            <p className="text-[#667185] text-[13px] dark:text-gray-400">
              Enter your credentials to access your account
            </p>
          </div>
          <div className="space-y-4">
            <div className="space-y-2 relative">
              <Label htmlFor="email" className="text-[101928]">
                EMAIL ADDRESS
              </Label>
              <Input
                className="pr-10"
            ...
            <div className="relative space-y-2">
              <Label htmlFor="password" className="text-[101928]">
                PASSWORD
              </Label>
              <Input
                className="pr-10"
              ...
              <div
                ...
                className="absolute cursor-pointer inset-y-0 right-0 top-[30%] flex items-center pr-3"
              >
                {passwordVisible ? (
                  <EyeIcon size={22} className=" text-[#667185]" />
                ) : (
                  <EyeOff size={22} className=" text-[#667185]" />
                )}
              </div>
            </div>
            ...
            <div className="flex items-center gap-2 text-[13px] justify-center">
              ...
              <span className="text-[#099137] cursor-pointer font-semibold">
                Create Account
              </span>
            </div>
          </div>
